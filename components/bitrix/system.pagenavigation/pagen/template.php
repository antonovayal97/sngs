...
<?if($arResult["bDescPageNumbering"] === true):?>
	...
	<?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		...
		<?endif?>
	<?else:?>
		<span class="pagen-disabled"><?=GetMessage("nav_begin")?></span> <span class="pagen-disabled"><?=GetMessage("nav_prev")?></span> 
	<?endif?>
	...
	<?while($arResult["nStartPage"] >= $arResult["nEndPage"]):?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<span class="pagen-active"><?=$NavRecordGroupPrint?></span>
	...
	<?else:?>
		<span class="pagen-disabled"><?=GetMessage("nav_next")?></span> <span class="pagen-disabled"><?=GetMessage("nav_end")?></span>
	<?endif?>
...
<?else:?>
	...
	<?while($arResult["nStartPage"] <= $arResult["nEndPage"]):?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<span class="pagen-active"><?=$arResult["nStartPage"]?></span>
